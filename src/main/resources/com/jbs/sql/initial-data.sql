...
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (1, 'OCP', 'Communication Policy', 1, 1, null);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (2, 'SC_001', 'General breach of Communication Policy', 1, 2, 1);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (3, 'SC_002', 'Downloading and/or distributing inappropriate material', 1, 3, 1);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (4, 'SC_003', 'Inappropriate use of Company IT equipment', 1, 4, 1);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (5, 'OFS', 'Food Safety & Quality Assurance Policy', 1, 5, null);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (6, 'SC_004', 'General breach of Food Safety Policy', 1, 6, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (7, 'SC_005', 'Allergens in processing area', 1, 7, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (8, 'SC_006', 'Throwing Product', 1, 8, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (9, 'SC_007', 'Breach of Dropped Meat Procedure', 1, 9, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (10, 'SC_008', 'Loose items in production area', 1, 10, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (11, 'SC_009', 'Smoking where not permitted', 1, 11, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (12, 'SC_010', 'Food and Drink where not permitted', 1, 12, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (13, 'SC_011', 'Failure to follow reasonable work instructions', 1, 13, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (14, 'SC_012', 'Failure to put soiled clothing in allocated bins', 1, 14, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (15, 'SC_013', 'Breach of site based jewellery or cosmetics policy', 1, 15, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (16, 'SC_014', 'Failure to keep lockers in hygienic state', 1, 16, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (17, 'OPP', 'Privacy Policy', 1, 17, null);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (18, 'SC_015', 'General breach of the privacy policy', 1, 18, 17);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (19, 'SC_016', 'Breach of confidentiality', 1, 19, 17);

INSERT INTO performance_action(id, code, name, status, category_id) VALUES (1, 'AB', 'Abandonment of employment', 1, 1);
INSERT INTO performance_action(id, code, name, status, category_id) VALUES (2, 'FR', 'Supervisor’s report', 1, 1);
INSERT INTO performance_action(id, code, name, status, category_id) VALUES (3, 'CS', 'Counselling session', 1, 1);
INSERT INTO performance_action(id, code, name, status, category_id) VALUES (4, 'WW', '1st warning', 1, 5);
INSERT INTO performance_action(id, code, name, status, category_id) VALUES (5, 'WS', '2nd warning', 1, 5);
INSERT INTO performance_action(id, code, name, status, category_id) VALUES (6, 'FW', 'Final warning', 1, 5);
