INSERT INTO performance_admin(id, code, type, value, status, sequence) VALUES (1, 'Resp_001', 'Support_Response', 'Yes', true, 1);
INSERT INTO performance_admin(id, code, type, value, status, sequence) VALUES (2, 'Resp_002', 'Support_Response', 'No', true, 2);
INSERT INTO performance_admin(id, code, type, value, status, sequence) VALUES (3, 'Resp_003', 'Support_Response', 'Declined', true, 3);
INSERT INTO performance_admin(id, code, type, value, status, sequence) VALUES (4, 'Interpreter_001', 'Interpreter', 'Yes', true, 1);
INSERT INTO performance_admin(id, code, type, value, status, sequence) VALUES (5, 'Interpreter_002', 'Interpreter', 'No', true, 2);

INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (1, 'OCP', 'Communication Policy', true, 1, null);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (2, 'SC_001', 'General breach of Communication Policy', true, 2, 1);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (3, 'SC_002', 'Downloading and/or distributing inappropriate material', true, 3, 1);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (4, 'SC_003', 'Inappropriate use of Company IT equipment', true, 4, 1);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (5, 'OFS', 'Food Safety & Quality Assurance Policy', true, 5, null);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (6, 'SC_004', 'General breach of Food Safety Policy', true, 6, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (7, 'SC_005', 'Allergens in processing area', true, 7, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (8, 'SC_006', 'Throwing Product', true, 8, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (9, 'SC_007', 'Breach of Dropped Meat Procedure', true, 9, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (10, 'SC_008', 'Loose items in production area', true, 10, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (11, 'SC_009', 'Smoking where not permitted', true, 11, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (12, 'SC_010', 'Food and Drink where not permitted', true, 12, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (13, 'SC_011', 'Failure to follow reasonable work instructions', true, 13, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (14, 'SC_012', 'Failure to put soiled clothing in allocated bins', true, 14, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (15, 'SC_013', 'Breach of site based jewellery or cosmetics policy', true, 15, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (16, 'SC_014', 'Failure to keep lockers in hygienic state', true, 16, 5);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (17, 'OPP', 'Privacy Policy', true, 17, null);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (18, 'SC_015', 'General breach of the privacy policy', true, 18, 17);
INSERT INTO performance_category(id, code, name, status, sequence, parent_category_id) VALUES (19, 'SC_016', 'Breach of confidentiality', true, 19, 17);

INSERT INTO performance_action(id, code, name, status, category_id) VALUES (1, 'AB', 'Abandonment of employment', true, 1);
INSERT INTO performance_action(id, code, name, status, category_id) VALUES (2, 'FR', 'Supervisor’s report', true, 1);
INSERT INTO performance_action(id, code, name, status, category_id) VALUES (3, 'CS', 'Counselling session', true, 1);
INSERT INTO performance_action(id, code, name, status, category_id) VALUES (4, 'WW', '1st warning', true, 5);
INSERT INTO performance_action(id, code, name, status, category_id) VALUES (5, 'WS', '2nd warning', true, 5);
INSERT INTO performance_action(id, code, name, status, category_id) VALUES (6, 'FW', 'Final warning', true, 5);

INSERT INTO letter_template(id, code, name, template_file, action_id, status) VALUES (1, '001', 'Abandonment of employement letter 1', 'letter.docx', 1, true);
